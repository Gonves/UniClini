    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h2 class="card-title">Cadastro de Paciente</h2>
                        <p class="card-text subtitle">Por favor, adicione as informações do paciente.</p>
                        <form class="form" action="{{ route('registrar_paciente') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="plano_saude" name="plano_saude" placeholder="Plano do paciente" required>
                            </div>
