...
// route gestor
    Route::get('/gestor/novo', [GestorController::class, 'create'])->name('gestor_create');
...
// route funcionario
    Route::get('/funcionario/novo', [FuncionarioController::class, 'create'])->name('funcionario_create');
Route::post('/funcionario/novo', [FuncionarioController::class, 'store'])->name('registrar_funcionario');

// route medico
    Route::get('/medico/novo', [MedicoController::class, 'create'])->name('medico_create');
...
// route paciente
    ...
    Route::get('/paciente/index', [PacienteController::class, 'index'])->name('paciente_index');
...
// route consulta
    Route::get('/consulta/index', [ConsultaController::class, 'index'])->name('consulta_index');
